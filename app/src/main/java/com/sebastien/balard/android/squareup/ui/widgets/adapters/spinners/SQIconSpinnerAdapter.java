...
public class SQIconSpinnerAdapter<T extends SQIconSpinnerAdapter.SQIconSpinnerAdapterItem> extends
        SQAbstractSpinnerAdapter<T> {

    public interface SQIconSpinnerAdapterItem extends SQAbstractSpinnerAdapterItem {
        int getItemIconDrawable();
    }

    public SQIconSpinnerAdapter(Context pContext, List<T> pElements) {
    ...
    public View getView(int pPosition, View pConvertView, ViewGroup pViewGroup) {
        ...
        vViewHolder.mImageView.setImageResource(mListItems.get(pPosition).getItemIconDrawable());
