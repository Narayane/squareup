 ...
 */
public class SQDealDaoImpl extends BaseDaoImpl<SQDeal, Long> {

    public SQDealDaoImpl(ConnectionSource pConnectionSource, DatabaseTableConfig<SQDeal> pTableConfig) throws
            SQLException {
