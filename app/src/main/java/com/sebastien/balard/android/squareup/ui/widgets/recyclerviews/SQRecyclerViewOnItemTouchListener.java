...
public class SQRecyclerViewOnItemTouchListener implements RecyclerView.OnItemTouchListener {

    public interface OnItemTouchListener {

        void onClick(RecyclerView.ViewHolder pViewHolder, int pPosition);

        void onLongClick(RecyclerView.ViewHolder pViewHolder, int pPosition);
    ...
    public SQRecyclerViewOnItemTouchListener(Context pContext, final RecyclerView pRecyclerView, final
        ...
        mGestureDetector = new GestureDetector(pContext, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onSingleTapUp(MotionEvent pMotionEvent) {
                ...
                if (vView != null && mItemTouchListener != null) {
                    mItemTouchListener.onClick(pRecyclerView.getChildViewHolder(vView), pRecyclerView
                            .getChildAdapterPosition(vView));
                }
                return true;
            }
            ...
            public void onLongPress(MotionEvent pMotionEvent) {
                View vView = pRecyclerView.findChildViewUnder(pMotionEvent.getX(), pMotionEvent.getY());
                if (vView != null && mItemTouchListener != null) {
                    mItemTouchListener.onLongClick(pRecyclerView.getChildViewHolder(vView), pRecyclerView
                            .getChildAdapterPosition(vView));
                }
            }
        });
